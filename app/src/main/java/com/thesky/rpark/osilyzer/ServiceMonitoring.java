...
/**
 * Created by rpark on 2017-10-14.
 */
...
public class ServiceMonitoring {
    ...
    public static class ServiceMonitoringBR extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if(isRunningService(context, PowerBalanceBTService.class) == false) {
                context.startService(new Intent(context, PowerBalanceBTService.class));
            }
        }
    }
